			...
			<table style="border: 1px solid black; padding: 12px;width:100%;"; >
				<thead style="border: 1px solid black;padding: 12px;";>
					<tr style="border: 1px solid black";>
						...
						<th style="border: 1px solid black;padding: 12px;background-color: black;color:white;";>name</th>
						...
						<th style="border: 1px solid black;padding: 12px;background-color: black;color:white;";>address</th>
						<th style="border: 1px solid black;padding: 12px;background-color: black;color:white;";>contact</th>
						<th style="border: 1px solid black;padding: 12px;background-color: black;color:white;";>pincode</th>
...
$selectquery ="select * from hospitaldetail";
...
while($res = mysqli_fetch_array($query))
{
	...
	?>
					<tr style="border: 1px solid black";>
						...
						<td style="border: 1px solid black;padding: 12px;background-color: red;color:white;";><?php echo $res['name']; ?></td>
						...
						<td style="border: 1px solid black;padding: 12px;background-color: red;color:white;";><?php echo $res['city']; ?></td>
							<td style="border: 1px solid black;padding: 12px;background-color: red;color:white;";><?php echo $res['address']; ?></td>
							<td style="border: 1px solid black;padding: 12px;background-color: red;color:white;";><?php echo $res['contact']; ?></td>
							<td style="border: 1px solid black;padding: 12px;background-color: red;color:white;";><?php echo $res['pincode']; ?></td>
